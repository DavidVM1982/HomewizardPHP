...
echo '<h2>Wind</h2><table id="table" align="center"><thead><tr><th valign="bottom">Datum</th><th>Windspeed<br/>km/h</th><th>Gust<br/>km/h</th><th>Direction</th></tr></thead><tbody>';
...
if(!isset($_POST['Show_All'])) {$sql .= " LIMIT 0,25";} else {$sql .= " LIMIT 0,5000";}
if(!$result = $db->query($sql)){ die('There was an error running the query [' . $db->error . ']');}
echo '<table id="table_day" align="center"><thead><tr><th>Datum</th><th>Windspeed</th><th>Gust</th><th>Direction</th></tr></thead><tbody>';
while($row = $result->fetch_assoc()){
	echo '<tr>
