...
<div class="isotope"><div class="item temprain gradient"><h2>Wind</h2><table width="100%" align="center"><thead><tr><th></th><th>Windspeed<br/>km/h</th><th>Gust<br/>km/h</th><th>Direction</th></tr></thead><tbody>';
...
if(!$result = $db->query($sql)){ die('There was an error running the query [' . $db->error . ']');}
echo '<div class="item temprain gradient" ><h2>Max wind per dag</h2><table width="100%" align="center"><thead><tr><th></th><th>Windspeed<br/>km/h</th><th>Gust<br/>km/h</th></tr></thead><tbody>';
while($row = $result->fetch_assoc()){
	echo '<tr>
...
if(!$result = $db->query($sql)){ die('There was an error running the query [' . $db->error . ']');}
echo '<div class="item temprain gradient"><h2>Max wind per maand</h2><table width="100%" align="center"><thead><tr><th></th><th>Windspeed<br/>km/h</th><th>Gust<br/>km/h</th></tr></thead><tbody>';
while($row = $result->fetch_assoc()){
	echo '<tr>
