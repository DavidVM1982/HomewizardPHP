...
<div class="isotope"><div class="item temprain"><h2>Regen per dag</h2><table id="table" align="center"><thead><tr><th scope="col"></th><th scope="col">mm</th></tr></thead><tbody>';
...
if(!$result = $db->query($sql)){ die('There was an error running the query [' . $db->error . ']');}
echo '<div class="item temprain"><h2>Regen per maand</h2><table id="table_day" align="center"><thead><tr><th></th><th>mm</th><th>dagen</th></thead><tbody>';
while($row = $result->fetch_assoc()){
	echo '<tr>
